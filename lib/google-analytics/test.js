...
describe('Google Analytics', function(){
  ...
  describe('Universal with Enhanced Ecommerce', function(){
    var settings = {
    ...
    it('should require ec.js', function(){
      analytics.track('completed order', { orderId: 'ee099bf7' });
      analytics.called(window.ga, 'require', 'ec');
      analytics.assert(ga.enhancedEcommerceLoaded);
    });

    it('should set currency for ec.js when currency set', function(){
      analytics.track('completed order', { orderId: 'ee099bf7', currency: 'USD' });
    ...
    it('should send simple ecommerce data', function(){
      analytics.track('completed order', { orderId: '7306cc06' });
      analytics.assert(2 == window.ga.args.length);

      analytics.deepEqual(window.ga.args[1], ['ec:setAction', 'purchase']);
    });
